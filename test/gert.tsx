...
useEffect(()=> {
  ...
  setValue("product_description",editProduct?.product_description),
  setValue("gender",editProduct?._id),
  setValue("colors",currentColors),
  setValue("sizes",currentSize),
  setValue("brands",editProduct?.brands?._id),
  setValue("cat_id",editProduct.cat_id?._id);
  ...
  const URL = `http://localhost:8282/product/edit/${productData._id}`;
  async function handleEditSubmit(e: any) {
    ...
    const product = {
      ...
      gender: editProduct?._id,
      colors: editProduct?.colors,
      sizes: editProduct?.sizes,
      brands: editProduct?.brands?._id,
      cat_id: editProduct.cat_id?._id,
